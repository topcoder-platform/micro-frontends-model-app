# Topcoder Model Microapp

This is a [single-spa](https://single-spa.js.org/) example Model microapp.
...
- As this app can be loaded only inside a frame single-spa, you have to run a `micro-frontends-frame` frame app and configure it to use the URL `http://localhost:8504/topcoder-micro-frontends-model-app.js`.
...
- Now you have to configure frame app to use the URL provided by Heroku like `https://<APP-NAME>.herokuapp.com/topcoder-micro-frontends-model-app.js` to load this microapp.
