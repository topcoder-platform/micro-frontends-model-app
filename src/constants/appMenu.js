   ...
   },
   {
     ...
     children: [
       ...
       },
       {
         ...
         path: "/model/standards/kafka-publish-receive-events",
         id: "kafka-publish-receive-events",
         fileName: "kafka-publish-receive-events.mdx",
         filePath: "/standards",
       },
       {
         title: "Kafka / ES : Avoid Race Condition",
         path: "/model/standards/kafka-es-avoid-race-condition",
         id: "kafka-es-avoid-race-condition",
         fileName: "kafka-es-avoid-race-condition.mdx",
         filePath: "/standards",
       },
       {
