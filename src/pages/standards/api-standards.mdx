...
<MTable 
  ...
  data={[
      { resource: "/members", get: "Returns a list of members", post: "Create a new member", put: "Bulk update of members", patch: "Method not allowed (405)", delete: "Delete all members" },
      { resource: "/members/:handle", get: "Returns a specific member", post: "Method not allowed (405)", put: "Update the specified member", patch: "Partially update the specified member", delete: "Delete a specific member" }
    ]}
  title="empty" />
